...
df_dict1 = ref_dict.copy()
df_dict1['variable'] = list( map(lambda x: x.lower(), df_dict1['variable']))
df_dict1.set_index(['variable'], inplace=True)

df_dict1.loc['bloom', 'long_name']