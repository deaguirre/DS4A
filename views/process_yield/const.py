...
ns = 'yield'
yield_modal_specs = modal_specs[modal_specs['Output'] == 'yield']
yield_modal_ls = {}

for i in range(len(yield_modal_specs['Modal'].unique())):
    temp_specs = yield_modal_specs[yield_modal_specs['Modal'] == i+1]
    
    yield_modal_ls['M{}'.format(i+1)] = [
        {
...
# Utilization
# P.ej. yield_modal_ls['M1']   ---> refers to Modal1
    ...
    'nodes':[
            {
                ...
                'x':0, 'y':200, 'size':50, 
                'font':{'color':'#ffffff', 'background':'#800101', 'strokeWidth':0, 'strokecolor':'black', 'size':20} 
            },
            {
                'id':2,
                'label': 'Washing', 
            ...
            },
            {
                ...
                'x': 500, 'y':500,
                'label':'Heavy liquour', 'font':{'color':'black', 'background':'white'}
            },
        ],
        'edges':[
