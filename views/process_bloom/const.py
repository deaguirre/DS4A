...
ns = 'bloom'
bloom_modal_specs = modal_specs[modal_specs['Output'] == 'bloom']
bloom_modal_ls = {}

for i in range(len(bloom_modal_specs['Modal'].unique())):
    temp_specs = bloom_modal_specs[bloom_modal_specs['Modal'] == i+1]
    
    bloom_modal_ls['M{}'.format(i+1)] = [
        {
...
# Utilization
# P.ej. bloom_modal_ls['M1']   ---> refers to Modal1
...
bloom_nodes = {
    'nodes':[
            ...
            },
            {
                ...
                'x':800, 'y':200, 'size':50, 
                'font':{'color':'#ffffff', 'background':'#187025', 'strokeWidth':0, 'strokecolor':'black', 'size':20} 
            },
            {
                'id':6,
            ...
            },
            {
                ...
                'x': 500, 'y':500,
                'label':'Heavy liquour', 'font':{'color':'#ffffff', 'background':'#187025', 'strokeWidth':0, 'strokecolor':'black', 'size':20}
            },
        ],
        'edges':[
